...
?>
<a href="slider/slider.php"><i class="fas fa-sliders-h"></i> Check out our price slider</a><br/>
<a href="viewcart.php"> <i class="fas fa-shopping-cart"></i> View your cart</a>
<?
